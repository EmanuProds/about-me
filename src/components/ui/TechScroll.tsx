...
const TECH_CARD_CLASSES =
  "group flex flex-col items-center justify-center p-6 m-2 min-w-[120px] rounded-2xl bg-gray-300/40 dark:bg-black/30 backdrop-blur-sm border border-gray-400/20 dark:border-gray-200/20 hover:bg-slate-400/40 dark:hover:bg-slate-600/40 hover:scale-105 transition-all duration-300 ease-out";
const TECH_ICON_CLASSES =
  "h-10 w-10 mb-3 group-hover:scale-110 transition-transform duration-300";
const TECH_TEXT_CLASSES =
  "text-sm font-medium text-gray-900 dark:text-gray-100 group-hover:text-gray-700 dark:group-hover:text-gray-200 transition-colors duration-300";
...
const TechCard = ({
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center p-6 m-2 min-w-[120px] rounded-2xl bg-gray-300/40 dark:bg-black/30 backdrop-blur-sm border border-gray-400/20 dark:border-gray-200/20 animate-pulse">
        <div className="h-10 w-10 bg-gray-400/30 rounded mb-3" />
...
const TechRow = ({
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div
        className={`flex gap-4 md:gap-6 ${animationClass} hover:[animation-play-state:paused]`}
      >
